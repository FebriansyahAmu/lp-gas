...
<!-- Section 2: List Gas -->
<section class="d-flex justify-content-center align-items-center py-5" style="background-color: #f9f9f9; min-height: 120vh;">
    <div class="container">
        <div class="d-flex justify-content-center mb-4">
            <h1 class="text-black">In Sale</h1>
        </div>
        <p class="mb-5 text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus ab velit est!
            Accusantium vitae ex provident, a.</p>
        <div class="row">
            <!-- Card 1 -->
            ...
            <div class="col-md-4 col-sm-6 col-12 mb-4">
                <div class="card shadow-lg hover-shadow zoom-effect">
                    <img class="card-img-top img-fluid" src="img/gas.jpeg" alt="Gas 2">
                    <div class="card-body">
                        <div class="text-center">
                            <span class="badge text-bg-success text-center fs-6">Rp.18.000</span>
                        </div>
            ...
            <div class="col-md-4 col-sm-6 col-12 mb-4">
                <div class="card shadow-lg hover-shadow zoom-effect">
                    <img class="card-img-top img-fluid" src="img/gas.jpeg" alt="Gas 3">
                    <div class="card-body">
                        <div class="text-center">
                            <span class="badge text-bg-success text-center fs-6">Rp.18.000</span>
                        </div>
...
<!-- Section 3: About Us -->
<section class="w-100 bg-dark-subtle py-5 d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-black mb-4 mb-md-0">
                ...
                <p>
                    Kami adalah perusahaan yang bergerak di bidang distribusi gas, menyediakan berbagai jenis gas untuk kebutuhan rumah tangga dan industri. Kami berkomitmen untuk memberikan layanan terbaik dengan produk berkualitas tinggi.
                </p>
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus, itaque. Amet asperiores odio illum aliquam incidunt ex unde aperiam dicta, autem est explicabo ipsa exercitationem nihil soluta odit consequuntur accusamus.
                </p>
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum molestiae nesciunt accusamus non quis ad officia nisi! Nam, sunt ipsum at, deleniti pariatur perspiciatis beatae ratione velit nisi officiis repellat.
                </p>
            </div>
            <!-- Kolom kanan: Gambar -->
            <div class="col-md-6">
